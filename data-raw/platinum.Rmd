...
if (!file.exists("spectra/HepG2_and_MCF10A_Cis.spectra.Rdata")) {
  ...
  save(hepg2.cis, mcf10a.cis, file = "HepG2_and_MCF10A_Cis.spectra.Rdata")
  rm(vcfs)
} else {
...
## Cosine similarity among spectra
...
The is only one major dimension, and it is due
mainly to CCC > CTC, CCT > CTT, and GCC > CAG mutations.

### How well to combinations of COSMIC signatures SBS31 and SBS35 reconstruct experimental signatures?
...
constructed pretty well, and  
Oxaliplatin is not reconstructed as well.
