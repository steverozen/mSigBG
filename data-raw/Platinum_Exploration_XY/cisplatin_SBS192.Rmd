...
```{r,fig.height=2, fig.width=7}
pcat(bg.mcf10a.192$background.sig)
```
...
```{r}
<<<<<<< HEAD:data-raw/Platinum_Exploration_XY/Platinum_192_XY.Rmd
...
>>>>>>> a0c41c7f0a6564ccc95d7049f657567ed11d74b7:data-raw/cisplatin_SBS192.Rmd
legend("bottomright", legend = colnames(pw.subsim), col=1:21, pch=1, cex = 0.8)
```
```{r, fig.height=4, fig.width=4}
gplots::heatmap.2(x = pw.subsim,
                  dendrogram = "column",
                  margins = c(15, 15),
                  cex.axis = 0.9,
                  symm = TRUE,
