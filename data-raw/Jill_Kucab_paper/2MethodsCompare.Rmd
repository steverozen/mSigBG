...
---
Description: 
This file compares the cosine similarity between signatures after background separation using our method and the signature published by Jill (Using Jill's background separation methods). 
