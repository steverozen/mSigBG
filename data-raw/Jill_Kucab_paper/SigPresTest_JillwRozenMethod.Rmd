...
# The Case Studies can be deleted. No longer relavent

# Case Studies 
-----------------------------------------------------------------------------------------------------------------------------------------------
### Case study: Control samples by Jill, Will there be signatures after Rozen Method?
```{r}
...
Inferred spectra with Rozen Method
```{r, fig.height=3, fig.width=10}
pcat(infer_spec_M1(compound.spectra, compound.sep))
```


------------------------------------------------------------------------------------------------------------------------------------------------------
### Case study: No signature by Jill, Will there be signature after Rozen Method?
"MSM0.47" "MMS..100.uM."

Input spectra 
```{r, fig.height=3, fig.width=10}
pcat(compound.spectra)
```
Inferred signature with Rozen Method
```{r, fig.height=1.5, fig.width=10}
pcat(compound.sep$inferred.target.sig.as.catalog)
```
...
pcat(jill.bg$input.spectra[,1:3])
```
